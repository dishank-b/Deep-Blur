...
parser = argparse.ArgumentParser(description='AutoFocus GAN')
...
parser.add_argument('--phase', dest='phase', default='train', help='train, test, graph')
parser.add_argument('--root_dir', dest='phase', default="", help='Root of the directory')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = pix2pix(sess, image_size=args.fine_size, batch_size=args.batch_size,
                        ...
                        root_dir=args.root_dir, gen_graph=args.phase)
